...
class EthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this, "EthActivity Launched", Toast.LENGTH_SHORT).show()
        ...
        Log.d("EthActivity", "Received data: coin_name=$coinName, current_price=$currentPrice, percentage_change=$percentageChange")
...
//                }
            ...
            try {
                ...
                if (ethResponse.isSuccessful) {
                    ...
                    withContext(Dispatchers.Main) {
                        // Update UI for BTC
                        updateCoinUI(ethData, "ETH")
                    }
                } else {
                    Log.e("EthActivity", "Error fetching data for ETH: ${ethResponse.errorBody()}")
                }
            } catch (e: Exception) {
                Log.e("EthActivity", "Exception while fetching data: ${e.localizedMessage}")
            }
        }
    }
    ...
    private fun setupLineChart(coinData: CoinData?, coinType: String) {
        ...
        lineChart.axisLeft.axisMaximum = 5000f
