...
class SolActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this, "SolActivity Launched", Toast.LENGTH_SHORT).show()
        ...
        Log.d("SolActivity", "Received data: coin_name=$coinName, current_price=$currentPrice, percentage_change=$percentageChange")
            ...
            try {
                ...
                if (solResponse.isSuccessful) {
                    ...
                    withContext(Dispatchers.Main) {
                        // Update UI for BTC
                        updateCoinUI(solData, "SOL")
                    }
                } else {
                    Log.e("SolActivity", "Error fetching data for SOL: ${solResponse.errorBody()}")
                }
            } catch (e: Exception) {
                Log.e("SolActivity", "Exception while fetching data: ${e.localizedMessage}")
            }
        }
    }
